...
#define LEDC_HS_CH0_GPIO       (10)
#define LEDC_HS_CH0_CHANNEL    LEDC_CHANNEL_0


#define SW_UART_LOW (0)
#define SW_UART_HIGH (1)
...
{
	uartc=uartc+1;
  // debugTestPin = gpio_get_level(GPIO_OUTPUT_LED);
  if (debugTestPin == 0) {
...
{
  pinMode(GPIO_OUTPUT_LED, GPIO_MODE_OUTPUT);
  digitalWrite(GPIO_OUTPUT_LED, 1);
  debugTestPin = 1;
